...
$.templates({
	...
	button_group_orgUserGenerate: '<li><a href="#" aria-label="{{:name}}" name="{{:id}}" onclick="group_delete(\'{{:~descriptor.local_data.container_id}}\');">{{:name}}</a></li>',
	...
	button_group_orgEmailGenerate: '<li><a href="#" aria-label="{{:name}}" name="{{:id}}" onclick="group_delete(\'{{:~descriptor.local_data.container_id}}\');">{{:name}}</a></li>',

	// кнопки для строк
	button_edit: '<button type="button" class="btn btn-success btn-xs" aria-label="{{:name}}" name="{{:id}}" onclick="row_edit(\'{{:~descriptor.local_data.container_id}}\', \'{{:~entity.local_data.eid}}\');" title="{{:title}}"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>',
	button_show: '<button type="button" class="btn btn-xs" aria-label="{{:name}}" name="{{:id}}" onclick="row_show(\'{{:~descriptor.local_data.container_id}}\', \'{{:~entity.local_data.eid}}\');" title="{{:title}}"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>',
	button_delete: '<button type="button" class="btn btn-danger btn-xs" aria-label="{{:name}}" name="{{:id}}{{:~entity.local_data.eid}}" onclick="row_delete(\'{{:~descriptor.local_data.container_id}}\', \'{{:~entity.local_data.eid}}\');" title="{{:title}}"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>\n',
	button_question: '<button type="button" class="btn btn-xs" aria-label="{{:name}}" name="{{:id}}{{:~entity.local_data.eid}}" onclick="organizationRequest(\'{{:~descriptor.local_data.container_id}}\', \'{{:~entity.local_data.eid}}\');" title="{{:title}}"><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span></button>\n',

	// кнопки фильтра
	button_apply: '<button type="button" class="btn btn-default btn-xs" aria-label="{{:name}}" name="{{:id}}" onclick="apply_filter(\'{{:~descriptor.local_data.container_id}}\');" title="{{:title}}"><span class="glyphicon glyphicon-filter" aria-hidden="true"></span></button>\n',
	button_clear: '<button type="button" class="btn btn-default btn-xs" aria-label="{{:name}}" name="{{:id}}" onclick="clear_filter(\'{{:~descriptor.local_data.container_id}}\');" title="{{:title}}"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>\n',
	...
	scroller_data_cell: '<td{{if hideble}} class="hidden-xs hidden-sm hidden-md"{{/if}} name="{{:id}}" id="{{:id}}">' +
		'{{if nullSubstitute && nullSubstitute != "undefined" && ~entity.fields[id] && ~entity.fields[id].value == \'\'}}{{:nullSubstitute}}' +
		'{{else ~entity.fields[id] }}' +
			'{{if ~entity.fields[id].values && ~entity.fields[id].values["street_type"]}}<span><small>{{:~entity.fields[id]["values"]["street_type"]["value"]}}&nbsp;</small></span>{{/if}}' + 
