...
edit_entity_field_img: '<button id="field_{{:id}}_{{:~descriptor.fields.id.value}}_addbutton" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i><span>Добавить</span></button> <form hidden="" action="/file/upload" class="dropzone" id="field_{{:id}}_{{:~descriptor.fields.id.value}}"></form><div id="field_{{:id}}_{{:~descriptor.fields.id.value}}_preview" class="row dropzone-previews"></div>',
