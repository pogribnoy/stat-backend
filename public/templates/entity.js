$.templates({
	...
	entity_button_check: '<button type="button" class="btn btn-default" aria-label="{{:name}}" name="{{:id}}{{:~descriptor.local_data.eid}}" onclick="entityCheckOnly(\'{{:~descriptor.local_data.container_id}}\', \'{{:~descriptor.local_data.eid}}\');">{{:name}}</button>\n',
